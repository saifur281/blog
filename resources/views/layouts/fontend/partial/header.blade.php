...
<head>
    ...
    <!--==== Animate CSS ====-->
    <link rel="stylesheet" href="{{ asset('fontend/assets/plugins/animate/animate.min.css') }}">

    <!--==== Owl Carousel ====-->
    <link rel="stylesheet" href="{{ asset('fontend/assets/plugins/owl-carousel/owl.carousel.min.css') }}">

    <!--==== Magnific Popup ====-->
    <link rel="stylesheet" href="{{ asset('fontend/assets/plugins/magnific-popup/magnific-popup.css') }}">
