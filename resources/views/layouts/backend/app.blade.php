...
<head>
    ...
    <!----Toster Session flash message link --->
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Blog System Laravel</a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                <img src="/images/{{ Auth::user()->image ?  : 'user.png'  }}" width="48" height="48" alt="User" />
            </div>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2019 - 2012 <a href="javascript:void(0);">Sehjad - Saif Chy</a>.
            </div>
            <div class="version">
                <b>poward by: </b> Laravel
            </div>
        </div>
        <!-- #Footer -->
    </aside>
